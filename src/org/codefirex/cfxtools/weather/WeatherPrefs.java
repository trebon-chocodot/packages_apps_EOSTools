...
//        .putString("temp_f", b.getString("temp_f"))
//        .putString("temp_c", b.getString("temp_c"))
        .putString("temp", b.getString("temp"))
//        .putString("chill_f", b.getString("chill_f"))
//        .putString("chill_c", b.getString("chill_c"))
...
//        .putString("f1_temp_low_c", b.getString("f1_temp_low_c"))
//        .putString("f1_temp_high_c", b.getString("f1_temp_high_c"))
//        .putString("f1_temp_low_f", b.getString("f1_temp_low_f"))
//        .putString("f1_temp_high_f", b.getString("f1_temp_high_f"))
...
//        .putString("f2_temp_low_c", b.getString("f2_temp_low_c"))
//        .putString("f2_temp_high_c", b.getString("f2_temp_high_c"))
//        .putString("f2_temp_low_f", b.getString("f2_temp_low_f"))
//        .putString("f2_temp_high_f", b.getString("f2_temp_high_f"))
...
//        .putString("f3_temp_low_c", b.getString("f3_temp_low_c"))
//        .putString("f3_temp_high_c", b.getString("f3_temp_high_c"))
//        .putString("f3_temp_low_f", b.getString("f3_temp_low_f"))
//        .putString("f3_temp_high_f", b.getString("f3_temp_high_f"))
...
//        .putString("f4_temp_low_c", b.getString("f4_temp_low_c"))
//        .putString("f4_temp_high_c", b.getString("f4_temp_high_c"))
//        .putString("f4_temp_low_f", b.getString("f4_temp_low_f"))
//        .putString("f4_temp_high_f", b.getString("f4_temp_high_f"))
...
//        b.putString("temp_f", getPrefs(ctx).getString("temp_f", "unknown"));
//        b.putString("temp_c", getPrefs(ctx).getString("temp_c", "unknown"));
        b.putString("temp", getPrefs(ctx).getString("temp", "unknown"));
//        b.putString("chill_f", getPrefs(ctx).getString("chill_f", "unknown"));
//        b.putString("chill_c", getPrefs(ctx).getString("chill_c",  "unknown"));
...
//        b.putString("f1_temp_low_c",getPrefs(ctx).getString("f1_temp_low_c", "unknown"));
//        b.putString("f1_temp_high_c",getPrefs(ctx).getString("f1_temp_high_c", "unknown"));
//        b.putString("f1_temp_low_f",getPrefs(ctx).getString("f1_temp_low_f", "unknown"));
//        b.putString("f1_temp_high_f",getPrefs(ctx).getString("f1_temp_high_f", "unknown"));
...
//        b.putString("f2_temp_low_c",getPrefs(ctx).getString("f2_temp_low_c", "unknown"));
//        b.putString("f2_temp_high_c",getPrefs(ctx).getString("f2_temp_high_c", "unknown"));
//        b.putString("f2_temp_low_f",getPrefs(ctx).getString("f2_temp_low_f", "unknown"));
//        b.putString("f2_temp_high_f",getPrefs(ctx).getString("f2_temp_high_f", "unknown"));
...
//        b.putString("f3_temp_low_c",getPrefs(ctx).getString("f3_temp_low_c", "unknown"));
//        b.putString("f3_temp_high_c",getPrefs(ctx).getString("f3_temp_high_c", "unknown"));
//        b.putString("f3_temp_low_f",getPrefs(ctx).getString("f3_temp_low_f", "unknown"));
//        b.putString("f3_temp_high_f",getPrefs(ctx).getString("f3_temp_high_f", "unknown"));
...
//        b.putString("f4_temp_low_c",getPrefs(ctx).getString("f4_temp_low_c", "unknown"));
//        b.putString("f4_temp_high_c",getPrefs(ctx).getString("f4_temp_high_c", "unknown"));
//        b.putString("f4_temp_low_f",getPrefs(ctx).getString("f4_temp_low_f", "unknown"));
//        b.putString("f4_temp_high_f",getPrefs(ctx).getString("f4_temp_high_f", "unknown"));
