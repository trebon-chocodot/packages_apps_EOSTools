...
//        String theLetter = isF ? "F" : "C";
    ...
    protected static Bundle makeWeatherBundle(WeatherInfo info, boolean isF) {
        ...
        b.putString("current_code", String.valueOf(info.getCurrentCode()));
        ...
        b.putString("f1_current_code", String.valueOf(forecastInfo.getForecastCode()));
        ...
        b.putString("f2_temp_high", makeTempString(isF,
                String.valueOf(forecastInfo.getForecastTempHighF()),
                String.valueOf(forecastInfo.getForecastTempHighC())));
        b.putString("f2_current_code", String.valueOf(forecastInfo.getForecastCode()));
        ...
        b.putString("f3_temp_high", makeTempString(isF,
                String.valueOf(forecastInfo.getForecastTempHighF()),
                String.valueOf(forecastInfo.getForecastTempHighC())));
        b.putString("f3_current_code", String.valueOf(forecastInfo.getForecastCode()));
        ...
        b.putString("f4_temp_high", makeTempString(isF,
                String.valueOf(forecastInfo.getForecastTempHighF()),
                String.valueOf(forecastInfo.getForecastTempHighC())));
        b.putString("f4_current_code", String.valueOf(forecastInfo.getForecastCode()));
